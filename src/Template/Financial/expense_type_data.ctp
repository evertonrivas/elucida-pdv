...
<table class='table table-hover' id='tblResult'>
    <thead>
        <tr>
            ...
            <th>Nome</th>
            <th>Exibe p/ Lojas</th>
            <th>Exibe no Calend&aacute;rio</th>
    ...
    <?php foreach($data_list as $data): ?>
        <tr>
            <td class="first-column"><input type="checkbox" id="check_list[]" name="check_list[]" value="<?php echo $data->IDTIPODESPESA; ?>"></td>
            <td><?php echo $data->NOME; ?></td>
            <td><?php echo ($data->EXIBE_LOJA=="1")?"Sim":"N&atilde;o"; ?></td>
            <td><?php echo ($data->SALVA_CALENDARIO=="1")?"Sim":"N&atilde;o"; ?></td>
            <td class="last-column"><a href="<?php echo $this->Url->build('financial/expense_type_create/'.$data->IDTIPODESPESA);?>" class="btn btn-light btn-sm" id="btnFilter"><i class="fas fa-edit"></i> Editar</a></td>
        </tr>
    <?php endforeach;?>
    <?php else: ?>
