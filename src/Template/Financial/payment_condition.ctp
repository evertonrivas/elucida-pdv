...
<form id="frmRegs" name="frmRegs">
	<div class="card">
		<div class="card-header">
			<div class="row">
				<div class="col-sm">
					<i class="fas fa-angle-right"></i> Condi&ccedil;&otilde;es de Pagamento
				</div>
				<div lang="col-sm text-right">
					<a href="<?php echo $this->Url->build('/financial/payment_condition_create');?>" class="btn btn-success btn-sm"><i class="fas fa-plus-circle"></i> Nova</a>
