		...
		<div class="card-header">
			<div class="row">
				...
				<div lang="col-sm text-right">
					<a href='javascript:trash("<?php echo $this->Url->build('/financial/inflow_delete');?>",<?= json_encode($this->request->getParam("_csrfToken")) ?>)' class="btn btn-danger btn-sm"><i class="far fa-trash-alt"></i> Excluir</a>
					<a href="<?php echo $this->Url->build('/financial/inflow_create');?>" class="btn btn-success btn-sm"><i class="fas fa-plus-circle"></i> Nova</a>
				</div>
			</div>
		</div>
