...
<table class='table table-hover' id='tblResult'>
    ...
    <?php foreach($data_list as $data): ?>
        <tr>
            <td class="first-column"><input type="checkbox" id="check_list[]" name="check_list[]" value="<?php echo $data->IDLOJA.";".$data->ANO; ?>"></td>
            <td><?php echo $data->LOJA; ?></td>
            <td><?php echo $data->ANO; ?></td>
            <td><?php echo $data->NOME; ?></td>
            <td class="last-column"><a href="<?php echo $this->Url->build('/financial/budget_create/'.$data->IDLOJA.'/'.$data->ANO);?>" class="btn btn-light btn-sm" id="btnFilter"><i class="fas fa-edit"></i> Editar</a></td>
        </tr>
    <?php endforeach;?>
    <?php else: ?>
